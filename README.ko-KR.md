...
[English](README.md) | [繁體中文](README.zh-TW.md) | [日本語](README.ja-JP.md) | **한국어**
...
- **안전한 원자적 다운로드**：서버가 제공한 파일 이름을 경로 순회(path traversal) 공격으로부터 정화하고, 각 파일을 임시 `.part` 파일로 스트리밍한 뒤 전송이 완료되어야만 이름을 변경합니다. 다운로드가 중단되더라도 최종 파일 이름으로 잘린 파일이 남지 않습니다.
